...
def main() -> None:
    ...
    parser.add_argument("--ppocrv5-model-dir", type=Path, default=Path("models/fine-tuned-models/best_model"))
    parser.add_argument("--ppocrv5-char-dict", type=Path, default=Path("ppocr/utils/dict/ppocrv5_dict.txt"))
