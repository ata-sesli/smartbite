...
def _audit_image(
    ...
    *,
    ...
    if fallback_triggered:
        ...
        for orientation in ("rot90_cw", "rot90_ccw", "rot180"):
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="If the normal pass produces zero boxes, run +90/-90/180 fallback passes and map boxes back.",
    )
    ...
    payload = {
        ...
        "settings": {
            ...
            "rotation_fallback_on_no_box": args.rotation_fallback_on_no_box,
            "rotation_fallback_orientations": ["rot90_cw", "rot90_ccw", "rot180"],
        },
