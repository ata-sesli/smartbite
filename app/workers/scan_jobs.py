...
def build_pipeline(settings: Settings) -> MobileExpiryPipeline:
    return MobileExpiryPipeline(
        ...
        full_image_rotation_detector_rescue_enabled=settings.mobile_full_image_rotation_detector_rescue_enabled,
        full_image_rotation_detector_rescue_max_candidates=settings.mobile_full_image_rotation_detector_rescue_max_candidates,
        ...
        production_anchor_sibling_enabled=settings.mobile_production_anchor_sibling_enabled,
        paired_crop_evidence_enabled=settings.mobile_paired_crop_evidence_enabled,
        local_group_wide_crop_enabled=settings.mobile_local_group_wide_crop_enabled,
        rotation_wide_crop_enabled=settings.mobile_rotation_wide_crop_enabled,
        hardcase_recognizer_rescue_enabled=settings.mobile_hardcase_recognizer_rescue_enabled,
        hardcase_svtr_model_name=settings.mobile_hardcase_svtrv2_rec_model_name,
        hardcase_svtr_model_dir=settings.mobile_hardcase_svtrv2_rec_model_dir,
        hardcase_svtr_backend=settings.mobile_hardcase_svtrv2_rec_backend,
        hardcase_svtr_onnx_model_path=settings.mobile_hardcase_svtrv2_rec_onnx_path,
    )
