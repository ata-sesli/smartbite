<script lang="ts">
  ...
  import DetectorComparisonPanel from '../components/DetectorComparisonPanel.svelte';
  ...
  import MobileOracleForensicAuditPanel from '../components/MobileOracleForensicAuditPanel.svelte';
  import QueueList from '../components/QueueList.svelte';
  import RecognizerComparePanel from '../components/RecognizerComparePanel.svelte';
  ...
  import TestImagesPostRunCheckPanel from '../components/TestImagesPostRunCheckPanel.svelte';
...
<main class="console">
  ...
  <nav class="console-tabs" aria-label="Console sections">
    ...
    <button type="button" class:active={activeTab === 'detectorComparison'} on:click={() => switchTab('detectorComparison')}>Detector Comparison</button>
    ...
    <button type="button" class:active={activeTab === 'remainingCases'} on:click={() => switchTab('remainingCases')}>Remaining 9</button>
    <button type="button" class:active={activeTab === 'testImagesPostRunCheck'} on:click={() => switchTab('testImagesPostRunCheck')}>Test Images Check</button>
    <button type="button" class:active={activeTab === 'recognizerCompare'} on:click={() => switchTab('recognizerCompare')}>Recognizer Compare</button>
    <button type="button" class:active={activeTab === 'oracleForensics'} on:click={() => switchTab('oracleForensics')}>Oracle Forensics</button>
  ...
  {#if activeTab === 'detectorComparison'}
  ...
  {#if activeTab === 'remainingCases'}
    <FullPipelineReviewPanel
      title="Remaining 9 Cases"
      description="Current accepted hybrid detector/recognizer test64 run filtered to non-exact cases only."
      initialFilter="remaining"
      runIdOverride="test64_mobile_direct_20260529T231804Z"
    />
  {/if}

  {#if activeTab === 'testImagesPostRunCheck'}
    <TestImagesPostRunCheckPanel />
  {/if}

  {#if activeTab === 'recognizerCompare'}
    <RecognizerComparePanel />
  {/if}

  {#if activeTab === 'oracleForensics'}
    <MobileOracleForensicAuditPanel />
  {/if}
